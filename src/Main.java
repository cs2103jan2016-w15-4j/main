...
/**
 * Manipulate the texts in text file text can be added, deleted, displayed and
 * cleared all changes will be made in memory then stored in file saving is
 * automatic after each command.
 * 
 * @author Lim Ta Eu
 */
public class Main {
