...
public class CommandFactory {
	...
	public Command createAddCommandEvent(String data, DateTime start, DateTime end){
		AddCommand addCommand = new AddCommand();
	...
	public Command createEditCommandEvent(int taskId, DateTime start, DateTime end){
		EditCommand editCommand = new EditCommand();
		editCommand.initEditCommandEvent(taskId, start, end);
		return editCommand;
	}
	
	public Command createEditCommandNameAndDeadline(int taskId, String taskName, DateTime deadline){
		EditCommand editCommand = new EditCommand();
		editCommand.initEditCommandNameAndDeadline(taskId, taskName, deadline);
		return editCommand;
	}
	
	public Command createEditCommandNameAndEvent(int taskId, String taskName, DateTime start, DateTime end){
		EditCommand editCommand = new EditCommand();
